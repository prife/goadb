...
func TestSyncSendOctetString(t *testing.T) {
	...
	s := NewSyncConn(MakeTestConnBuf(&buf))
...
func TestSyncReadTime(t *testing.T) {
	s := NewSyncConn(MakeTestConnBytes(someTimeEncoded))
...
func TestSyncReadString(t *testing.T) {
	s := NewSyncConn(MakeTestConn("\005\000\000\000hello"))
...
func TestSyncReadStringTooShort(t *testing.T) {
	s := NewSyncConn(MakeTestConn("\005\000\000\000h"))
	_, err := s.ReadString()
...
func TestSyncReadBytes(t *testing.T) {
	s := NewSyncConn(MakeTestConn("\005\000\000\000helloworld"))
